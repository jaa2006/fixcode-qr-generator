...
function App() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-start py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <label className="theme-switch fixed top-4 right-4 z-50">
        <input 
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500 dark:text-gray-400">Convert your links into QR codes instantly</p>
      </div>

      <div className="flex flex-col items-center justify-center w-full max-w-7xl mx-auto gap-12">
        <QRCodeContainer />
        <DeveloperInfo />
      </div>
    </div>
